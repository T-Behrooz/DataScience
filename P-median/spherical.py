...
book = xlrd.open_workbook('d:\\data1.xls')
...
df.to_csv("d:\\Distances_NoTesla1_NoWeight.csv")
...
# 
pandas_from_csv = pd.read_csv('d:\\Distances_NoTesla1_NoWeight.csv',header=0,index_col='ID')
