...
output_path = 'd:\\cross_efficiency_3_output2.xlsx'
...
def main():
    try:
        ...
        # Sanitize column names for Excel
        sanitized_columns = [sanitize_column_name(col) for col in matrix_df.columns]
        matrix_df.columns = sanitized_columns
        ...
        try:
            ...
            # Use pandas' ExcelWriter for robust writing with headers
